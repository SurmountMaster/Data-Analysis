...
#matplotlib-3.6.3 numpy-1.19.0 pandas-1.4.4 scipy-1.9.3

# Import data (Make sure to parse dates. Consider setting index column to 'date'.)
df = pd.read_csv(r"C:\Users\chido\Downloads\github\Excel\freecodecamp-data-analysis-with-python-main\freecodecamp-data-analysis-with-python-main\page-view-time-series-visualizer\fcc-forum-pageviews.csv")
